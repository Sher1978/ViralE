...
const PLANS = [
  {
    ...
    icon: '🌱',
    color: '#4D9EFF',
    featuresEn: ['400 Credits included', 'ScriptLab standard access', 'Basic Storyboarding'],
    featuresRu: ['Включено 400 кредитов', 'Базовый доступ к монтажу', 'Стандартная раскадровка'],
  },
  {
    id: 'pro',
    name: 'Pro',
    ...
    color: '#00FFCC',
    popular: true,
    featuresEn: ['1000 Credits included', 'Full AI script editing', 'Smart Storyboard regeneration'],
    featuresRu: ['Включено 1000 кредитов', 'Полный ИИ монтаж сценариев', 'Умная регенерация кадров'],
  },
  {
    id: 'scale',
    name: 'Scale',
