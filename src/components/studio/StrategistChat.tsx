        ...
        {isOpen && (
          ...
          >
            ...
            <div 
              ...
              className="flex-1 overflow-y-auto p-4 space-y-4 custom-scrollbar z-10 relative"
            >
              {(() => {
                            ...
                            if (scriptText) {
                              return (
                                ...
                                >
                                  ...
                                  {locale === 'ru' ? 'Экспорт в Сценарную' : 'Export to Script Lab'}
                                </button>
                              );
                            }
                            return null;
            ...
            <AnimatePresence>
              {showScrollDown && (
                <motion.button
                  ...
                  className="absolute bottom-24 right-6 p-2.5 bg-purple-600/90 hover:bg-purple-500 text-white rounded-full shadow-lg border border-purple-500/30 backdrop-blur-md transition-all active:scale-95 z-[170] cursor-pointer flex items-center justify-center"
