      ...
      <nav className="relative z-50 flex justify-between items-center px-8 py-8 max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center gap-6 mr-4">
             <Link href="/landing-v1" locale={locale === 'ru' ? 'en' : 'ru'} className="group flex items-center gap-2">
      ...
      <footer className="relative z-10 py-16 border-t border-white/[0.03] bg-white/[0.01] backdrop-blur-3xl">
        <div className="max-w-7xl mx-auto px-10 flex flex-col md:flex-row justify-between items-center gap-12">
          ...
          <div className="flex gap-4">
            <Link href="/privacy" className="text-xs font-black uppercase tracking-widest text-white/40 hover:text-cyan-400 transition-colors">Privacy Policy</Link>
            <Link href="/terms" className="text-xs font-black uppercase tracking-widest text-white/40 hover:text-cyan-400 transition-colors">Terms of Service</Link>
            <Link href="/refund" className="text-xs font-black uppercase tracking-widest text-white/40 hover:text-cyan-400 transition-colors">Refund Policy</Link>
          </div>
        </div>
