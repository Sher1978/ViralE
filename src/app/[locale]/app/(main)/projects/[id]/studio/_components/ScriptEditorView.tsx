...
import { ArrowRight, ArrowLeft, AlignLeft, Sparkles, FileText, CheckCircle2 } from 'lucide-react';
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4">
          ...
          <button
            ...
            className="w-full sm:w-auto px-10 py-5 bg-purple-600 hover:bg-purple-500 text-white font-black text-[12px] uppercase tracking-[0.2em] rounded-[2rem] shadow-2xl shadow-purple-600/30 active:scale-95 disabled:opacity-40 disabled:scale-100 transition-all flex items-center justify-center gap-2"
          >
