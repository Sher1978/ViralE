...
export default function StudioPage() {
  ...
  // Import script generated by AI Strategist
  useEffect(() => {
    const handleExportEvent = (e: Event) => {
      const customEvent = e as CustomEvent;
      const text = customEvent.detail?.text;
      if (text) {
        addSystemLog('Получен текст сценария из ИИ-Стратега, импортируем...');
    ...
    const win = globalThis as any;
    win.addEventListener?.('strategist-export-script', handleExportEvent);
    return () => {
      win.removeEventListener?.('strategist-export-script', handleExportEvent);
    };
