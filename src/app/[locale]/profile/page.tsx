  ...
  const SETTINGS_SECTIONS = [
    {
      ...
      items: [
        { icon: '🎭', label: t('dnaLabel'), sub: t('dnaSub'), href: `/${locale}/profile/dna`, accent: '#D4AF37' },
        { icon: '👤', label: t('avatarLabel'), sub: t('avatarSub'), href: `/${locale}/profile/avatar`, accent: '#00FFCC' },
        { icon: '✈️', label: t('telegramLabel'), sub: t('telegramSub'), href: `/${locale}/profile/telegram`, accent: '#4D9EFF' },
      ],
    },
    {
      title: t('sectionSettings'),
      items: [
        { icon: '🔔', label: t('notifLabel'), sub: t('notifSub'), href: `/${locale}/profile/notifications`, accent: '#9B5FFF' },
        { icon: '🌙', label: t('themeLabel'), sub: t('themeSub'), href: `/${locale}/profile/theme`, accent: '#4D9EFF' },
        { icon: '🌍', label: t('langLabel'), sub: locale === 'ru' ? 'Русский' : 'English', href: `/${locale}/profile/language`, accent: '#00FFCC' },
      ],
    },
    {
      title: t('sectionPro'),
      items: [
        { icon: '🔑', label: t('byokLabel'), sub: t('byokSub'), href: `/${locale}/profile/byok`, accent: '#D4AF37' },
        { icon: '🔒', label: t('securityLabel'), sub: t('securitySub'), href: `/${locale}/profile/security`, accent: '#FF4D6D' },
      ],
    },
  ];
