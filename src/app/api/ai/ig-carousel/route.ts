  ...
  try {
    ...
    const systemPrompt = `
      ...
      2. СЛАЙДЫ 2-6 (ОСНОВНЫЕ СЛАЙДЫ — ДВУХЭТАЖНЫЙ ТЕКСТ: ТЕЗИС + ПОЯСНЕНИЕ):
         - text_on_slide: Слайды 2-6 должны быть сочными и глубокими (всего 25-35 слов на слайд). Форматируй текст в ДВА ЭТАЖА через перенос строки '\n':
           Строка 1 (Тезис): Емкий, громкий заголовок (3-6 слов, ЗАГЛАВНЫМИ БУКВАМИ или с двоеточием).
           Символ переноса строки '\n'
           Строка 2 (Пояснение): Сочное раскрытие мысли, практическая выгода или экспертный аргумент (15-25 слов).
           Пример: "ГЛАВНАЯ ОШИБКА ЭКСПЕРТОВ\nБольшинство авторов сливают 90% трафика, потому что не делают понятный призыв к действию в первых 3 секундах роликов."
