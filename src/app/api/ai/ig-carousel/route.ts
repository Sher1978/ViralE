  ...
  try {
    ...
    const systemPrompt = `
      ...
      ВЫДАЙ СТРОГИЙ JSON (БЕЗ РАЗМЕТКИ MARKDOWN, ТОЛЬКО ЧИСТЫЙ JSON):
      {
        ...
        "post_description": "Увлекательное описание-капшн для поста в Instagram, форматированное абзацами, мотивирующее пролистать карусель и написать кодовое слово...",
        "slides": [
          {
            "slide_number": 1,
            "role": "hook",
