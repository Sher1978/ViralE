  ...
  try {
    ...
    const systemPrompt = `
      ...
      2. СЛАЙДЫ 2-6 (ОСНОВНЫЕ СЛАЙДЫ — ДВУХЭТАЖНЫЙ ТЕКСТ: ТЕЗИС + ПОЯСНЕНИЕ):
         - text_on_slide: Слайды 2-6 должны быть богатыми, глубокими и сочными (всего 20-30 слов на слайд, 160-220 символов). Форматируй текст в ДВА ЭТАЖА через перенос строки '\n':
           Строка 1 (Тезис): Емкий, громкий заголовок (4-7 слов, ЗАГЛАВНЫМИ БУКВАМИ).
           Символ переноса строки '\n'
           Строка 2 (Пояснение): Сочное раскрытие мысли, практическая выгода или экспертный аргумент (15-25 слов).
           Пример: "ГЛАВНАЯ ОШИБКА ПРИ ВЫБОРЕ БАЙКА\n90% авторов покупают технику без глубокой юридической проверки документов. В итоге они теряют байки на первой же инспекции и остаются без денег."
