...
CREATE TABLE IF NOT EXISTS public.profiles (
    ...
    dna_answers JSONB DEFAULT '{}'::jsonb,
    raw_onboarding_data JSONB DEFAULT '{}'::jsonb,
    onboarding_completed BOOLEAN DEFAULT false,
    storybrand_raw_content TEXT,
    storybrand_filename TEXT,
    storybrand_file_size INTEGER,
    storybrand_updated_at TIMESTAMPTZ,
    partner_balance_usd NUMERIC DEFAULT 0,
...
RETURNS trigger AS $$
BEGIN
  INSERT INTO public.profiles (id, email, full_name, credits_balance, tier)
  VALUES (
    new.id, 
    new.email, 
    COALESCE(new.raw_user_meta_data->>'full_name', new.raw_user_meta_data->>'name', 'Media Creator'), 
    100, 
    'free'
  )
